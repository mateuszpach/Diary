...
import com.github.mateuszpach.diary.databinding.FragmentViewVideoBinding;
...
public class ViewVideoFragment extends Fragment {
    ...
    private FragmentViewVideoBinding binding;
    ...
    private void setupMediaPlayer() {
        try {
            ...
            mediaPlayer.setDisplay(binding.videoView.getHolder());
            mediaPlayer.prepare();
            setVideoSize();
    ...
    private void setVideoSize() {
        ...
        int screenWidth = binding.videoView.getMeasuredWidth();
        int screenHeight = binding.videoView.getMeasuredHeight();
    ...
    private void deleteEntry() {
        ...
        NavHostFragment.findNavController(ViewVideoFragment.this)
                .navigate(R.id.action_ViewVideoFragment_to_CatalogFragment);
    }
